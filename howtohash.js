...
const hash = sha256.update(value, 'utf8').digest('hex');
console.log({value, hash});
const hash2 = sha256.update(value, 'utf8').digest('hex');
console.log({hash2});
const hash3 = shajs('sha256').update(value, 'utf8').digest('hex');
console.log({hash3});
const hash4 = shajs('sha256').update(value, 'utf8').digest('hex');
console.log({hash4});
